...
public class AirportTest {
    ...
    public void shouldGetTransportMilitaryPlanes() {
        ...
        Assert.assertEquals(expectedMilitaryTransportPlanes, airport.getTransportMilitaryPlanes(),"Expected and result list of transport military planes aren't the same");
    }
    ...
    public void shouldGetPassengerPlaneWithMaxPassengersCapacity() {
        ...
        Assert.assertTrue((airport.getPassengerPlaneWithMaxPassengersCapacity()).equals(planeWithMaxPassengerCapacity),"Expected and result passenger plane with max passengers capacity aren't the same");
    }
    ...
    public void shouldGetBomberMilitaryPlanes() {
        ...
        Airport airport = new Airport(planes);
        Assert.assertEquals(expectedBomberMilitaryPlanes,airport.getBomberMilitaryPlanes(),"Expected and result list of bomber military planes aren't the same");
    }
}
