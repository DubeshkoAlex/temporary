...
public class Runner {
    ...
    public static List<Plane> expectedSortedByMaxLoadCapacityPlanes = Arrays.asList(
...
//        System.out.println("Plane with max passenger capacity: \n" + passengerAirport.getPassengerPlaneWithMaxPassengersCapacity());
        ...
        newPlanes  = airport.sortByMaxLoadCapacity();
       //System.out.println(().equals(expectedSortedByMaxLoadCapacityPlanes));
